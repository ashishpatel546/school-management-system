...
export default function ExaminationsPage() {
    ...
    const fetchStudents = async (overrideSessionId?: string, overridePage?: number) => {
        ...
        try {
            ...
            const res = await fetch(`${API_BASE_URL}/exams/dashboard?${params.toString()}`);
            if (res.ok) {
    ...
    useEffect(() => {
        Promise.all([
            ...
            fetch(`${API_BASE_URL}/exams/categories/active`).then(r => r.json())
        ...
        <main className="p-4 bg-slate-50 min-h-screen">
            <div className="max-w-7xl mx-auto">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <Link href="/dashboard/examinations/data-entry" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none">
                        Bulk Data Entry
                    </Link>
                </div>
